...
public interface LedgerEntryRepository extends JpaRepository<LedgerEntry, Long> {
    ...
    @Query("""
            select e.account as account,
                   coalesce(sum(case when e.direction = com.beomsu.pay.ledger.internal.EntryDirection.DEBIT
    ...
    @Query("""
            select coalesce(sum(case when e.direction = com.beomsu.pay.ledger.internal.EntryDirection.DEBIT
