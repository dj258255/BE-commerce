...
BE-commerce는 이커머스 플랫폼이고, 그 코어는 결제의 정합성입니다. 이 디렉터리는 **커머스·결제 도메인 설계**,
재현 실험, 아키텍처 결정 기록을 분리해 보관합니다.
...
| 순서 | 문서 | 확인할 내용 |
| ---: | --- | --- |
| 0 | [트러블슈팅 기록](TROUBLESHOOTING-LOG.md) | **지금 무엇이 열려 있고, 닫은 것은 어떻게 닫았나** |
...
| 7 | [결제 의사결정 검증](29-결제-의사결정-검증.md) · [포트폴리오 초안](30-결제-포트폴리오-초안.md) · [플랫폼 확장 계획](32-결제-플랫폼-확장-계획.md) · [정합성 운영 지표](33-결제-정합성-운영지표와-해외사례-적용.md) · [retry storm](34-결제-재시도와-retry-storm-실험.md) · [pending/posted](35-대사의-pending과-posted-경계.md) · [오케스트레이션](36-결제-오케스트레이션의-복잡성-이동-판단.md) · [hot entity](37-결제-원장의-hot-entity와-처리량.md) · [지급 대사 게이트](39-지급-확정은-대사-결과가-열어야-한다.md) · [작업 보드](PROJECT-BOARD.md) | 핵심 판단, 검증 지표, 확장 단계, 해외 사례, 일정·산출물 |
...
| [29. 결제 의사결정 검증](29-결제-의사결정-검증.md) | UNKNOWN, 웹훅, PG 브라운아웃, 복합결제, PCI 표현의 현재 결론과 미검증 범위 |
| [30. 결제 포트폴리오 초안](30-결제-포트폴리오-초안.md) | 4~5페이지 포트폴리오에 사용할 결제 핵심 서사 |
| [32. 결제 플랫폼 확장 계획](32-결제-플랫폼-확장-계획.md) | 해외 결제 플랫폼 원칙을 현재 규모로 축소 적용하는 단계·완료 조건·미검증 범위 |
| [33. 결제 정합성 운영 지표](33-결제-정합성-운영지표와-해외사례-적용.md) | 원장·대사·지급·웹훅·재시도를 completeness·timeliness·accuracy·explainability로 운영하는 기준 |
| [34. 결제 재시도와 retry storm](34-결제-재시도와-retry-storm-실험.md) | 승인·조회 재시도 경계와 retry 예산·장애 증폭 검증 |
| [35. 대사의 pending과 posted](35-대사의-pending과-posted-경계.md) | 사람 예외 PENDING과 외부 금융 pending을 분리하는 기준 |
| [36. 결제 오케스트레이션](36-결제-오케스트레이션의-복잡성-이동-판단.md) | 다중 PG가 복원력과 운영 복잡성 사이에서 만드는 선택 |
| [37. 원장 hot entity](37-결제-원장의-hot-entity와-처리량.md) | 강한 일관성·직렬화·잔액 스냅샷의 처리량 trade-off |
| [38. 지급 대사 엔진](38-지급-대사-엔진과-외부-reference.md) | 외부 지급 reference·pending·posted·금액·통화 경계를 결정적으로 판정 |
| [39. 지급 확정 게이트](39-지급-확정은-대사-결과가-열어야-한다.md) | `MATCHED` 대사 결과가 있을 때만 `PAID_OUT`과 원장 회수 이벤트를 허용 |
| [작업 보드](PROJECT-BOARD.md) | 목표·Milestone·Issue·PR·예상 시간·위험·완료 조건·검증 결과를 복원하는 관리 기록 |
